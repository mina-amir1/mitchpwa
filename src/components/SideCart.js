...
export default function SideCart({ isOpenCart, setIsOpenCart }) {
    return (
        <main
            className={
                " fixed overflow-hidden z-10 bg-gray-900 bg-opacity-25 inset-0 transform ease-in-out m-0" +
                (isOpenCart
            ...
            >
                <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <ul className="flex flex-col divide-y divide-gray-700">
                        ...
                        <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                            <div className="flex w-full space-x-2 sm:space-x-4">
                                <img className="flex-shrink-0 object-cover w-20 h-20 dark:border-transparent rounded outline-none sm:w-32 sm:h-32 dark:bg-gray-500" src="https://cdn.lorem.space/images/shoes/.cache/640x480/luis-felipe-lins-LG88A2XgIXY-unsplash.jpg" alt="Set of travel chargers" />
                                <div className="flex flex-col justify-between w-full pb-4">
                                    <div className="flex justify-between w-full pb-2 space-x-2">
                                        <div className="space-y-1">
                    ...
                    <div className="flex justify-end space-x-4">
                        <Link to="/cart" className="capitalize w-1/2 items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none text-center">
                            View Cart
                        </Link>
                        <button type="button" className="capitalize w-1/2 items-center justify-center rounded-md border-2 border-solid border-slate-600 py-3 px-4 text-base font-medium text-slate hover:bg-slate-600 hover:text-white focus:outline-none">
